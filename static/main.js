...
document.addEventListener('DOMContentLoaded', () => {
  const start = async () => {
    const imageTargets = [
      { src: '/static/assets/targets/facultad_de_ciencias_letras.mind', model: '/static/assets/models/scientist/scene.gltf', scale: { x: 0.01, y: 0.01, z: 0.01 } },
      ...
      { src: '/static/assets/targets/centro_investigacion.mind', model: '/static/assets/models/microscope/scene.gltf', scale: { x: 0.01, y: 0.01, z: 0.01 }},
      { src: '/static/assets/targets/biblioteca_fc.mind', model: '/static/assets/models/book/scene.gltf', scale: { x: 0.005, y: 0.005, z: 0.005 }},
